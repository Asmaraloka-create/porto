  ...
  id: {
    ...
    ui: {
      ...
      facts: [
        ...
        '🛠️ Stack: HTML, CSS, JavaScript, C++ (belajar)',
      ...
      journey: [
        ...
        { year: 'Now', text: 'Merancang game pixel dengan C++. Next: kolaborasi!' },
      ],
      getStarted: 'Mulai →',
    ...
    projects: [
      ...
      },
      {
        slug: 'game-pixel-cpp',
        title: 'Game Pixel (C++)',
        category: 'Game Pixel • C++',
        desc: 'Game pixel yang dibuat dengan C++, masih tahap perancangan. Stay tuned.',
        longDesc:
          'Proyek game pixel dengan C++ — saat ini masih tahap perancangan: konsep karakter, tilemap, dan mekanisme game. Progres diupdate berkala di GitHub.',
        tech: ['C++', 'Pixel Art', 'Desain Game'],
    ...
    postBodies: {
      ...
      'logika-dari-game': [
        ...
        'Mulai dari HTML, CSS, dan JavaScript — seperti Gaming Website Project saya — lalu naik ke C++ untuk game pixel yang lebih serius.',
      ],
    },
  },
  ...
  en: {
    ...
    ui: {
      ...
      facts: [
        ...
        '🛠️ Stack: HTML, CSS, JavaScript, C++ (learning)',
        '✉️ candrayasa.as@gmail.com',
        '🚀 Live: Kurumi Academy & Gaming Website',
      ],
      ...
      journey: [
        ...
        { year: 'Web', text: 'Kurumi Academy + Gaming Website live — HTML, CSS, JavaScript.' },
        { year: 'Now', text: 'Designing a pixel game in C++. Next: collaboration!' },
      ],
    ...
    projects: [
      ...
      },
      {
        slug: 'game-pixel-cpp',
        title: 'Pixel Game (C++)',
        category: 'Pixel Game • C++',
        desc: 'A pixel game built with C++, still in the design stage. Stay tuned.',
        longDesc:
          'A pixel game project in C++ — currently in the design stage: character concepts, tilemaps, and game mechanics. Progress is updated regularly on GitHub.',
        tech: ['C++', 'Pixel Art', 'Game Design'],
    ...
    postBodies: {
      ...
      'logika-dari-game': [
        ...
        'Start with HTML, CSS, and JavaScript — like my Gaming Website Project — then level up to C++ for a more serious pixel game.',
      ],
    },
  },
};
